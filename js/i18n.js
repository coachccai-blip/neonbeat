...
const STRINGS = {
  fr: {
    ...
    mode_keys: 'touches',
    rank_title: 'CLASSEMENT', board_open: 'CLASSEMENT GÉNÉRAL', board_mine: 'MES SCORES',
    board_mine_empty: 'Tu n’as pas encore joué ce morceau dans ce mode.',
    board_rank: 'Ton rang : {n} sur {total}',
    board_global: 'CLASSEMENT GÉNÉRAL', board_publish: 'PUBLIER MES SCORES',
  ...
  en: {
    ...
    mode_keys: 'keys',
    rank_title: 'LEADERBOARD', board_open: 'OVERALL RANKING', board_mine: 'MY SCORES',
    board_mine_empty: 'You haven’t played this track in this mode yet.',
    board_rank: 'Your rank: {n} of {total}',
    board_global: 'OVERALL RANKING', board_publish: 'PUBLISH MY SCORES',
  ...
  zh: {
    ...
    mode_keys: '键',
    rank_title: '排行榜', board_open: '总排行榜', board_mine: '我的成绩',
    board_mine_empty: '你还没有在此模式下玩过这首歌。',
    board_rank: '你的排名：第 {n} / 共 {total}',
    board_global: '总排行榜', board_publish: '发布我的成绩',
